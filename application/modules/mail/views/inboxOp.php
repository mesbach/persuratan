    ...
    <div class="col-sm-9">
        <section class="panel">
            <header class="panel-heading wht-bg">
                <h4 class="gen-case">Surat Masuk (34)
                    ...
                    <table class="table table-inbox table-hover">
                        <tbody>
                            <tr class="unread">
                                ...
                                <td class="view-message  dont-show"><a href="<?php echo base_url(); ?>mail/operator/viewMail">ABC Company</a></td>
                                <td class="view-message "><a href="<?php echo base_url(); ?>mail/operator/viewMail">Lorem ipsum dolor imit set.</a></td>
                            ...
                            <tr class="unread">
                                ...
                                <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                                <td class="view-message dont-show"><a href="<?php echo base_url(); ?>mail/operator/viewMail">Mr Bean</a></td>
                                <td class="view-message"><a href="<?php echo base_url(); ?>mail/operator/viewMail">Hi Bro, Lorem ipsum dolor imit</a></td>
                            ...
                            <tr class="">
                                ...
                                <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                                <td class="view-message dont-show"><a href="<?php echo base_url(); ?>mail/operator/viewMail">Jonathan Smith</a></td>
                                <td class="view-message"><a href="<?php echo base_url(); ?>mail/operator/viewMail">Lorem ipsum dolor sit amet</a></td>
                                <td class="view-message inbox-small-cells"></td>
                            ...
                            <tr class="">
                                ...
                                <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                                <td class="view-message dont-show"><a href="<?php echo base_url(); ?>mail/operator/viewMail">Facebook</a></td>
                                <td class="view-message"><a href="<?php echo base_url(); ?>mail/operator/viewMail">Dolor sit amet, consectetuer adipiscing</a></td>
                                <td class="view-message inbox-small-cells"></td>
