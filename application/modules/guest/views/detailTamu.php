                    ...
                    if($detil[0]->verifikasi==0)
                        { 
                            ...
                            echo '
                                ...
                                <li class="divider"></li>
                                <li><a href="'.base_url().'guest/'.$this->session->userdata['logged_in']['privilege'].'/edit/'.$detil[0]->id.'"><i class="fa fa-edit"></i> Ubah</a></li>';
                        }
                    else if($detil[0]->verifikasi==1)
                        { 
                            echo '<li><a href="#" ><i class="fa fa-check"></i> Selesai</a></li>
