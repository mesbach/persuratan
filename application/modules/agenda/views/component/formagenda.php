<?php if(isset($agendaedit)) { echo form_open_multipart('agenda/'. $this->session->userdata["logged_in"]["privilege"].'/updateagenda/'.$agendaedit[0]->id); } else { echo form_open_multipart('agenda/'. $this->session->userdata["logged_in"]["privilege"].'/save');}?>
    <div class="row">
        <div class="col-md-6">
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input value="<?php if (isset($agendaedit)) {echo $agendaedit[0]->judul;} ?>" type="text" class="form-control" name="judul" placeholder="Nama Agenda">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input value="<?php if (isset($agendaedit)) {echo $agendaedit[0]->awal;} else { echo date('d-m-Y H:i'); }  ?>" size="16" type="text" name="awal" class="form_datetime form-control" value="">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input size="16" type="text" value="<?php if (isset($agendaedit)) {echo $agendaedit[0]->akhir;} else { echo date('d-m-Y H:i'); }  ?>" name="akhir" class="form_datetime form-control" value="">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input value="<?php if (isset($agendaedit)) {echo $agendaedit[0]->tempat;}  ?>" type="text" class="form-control" name="tempat" placeholder="Tempat Agenda">
                        <input value="<?php if (isset($agendaedit)) {echo $agendaedit[0]->id;}  ?>" type="hidden" class="form-control" name="idagenda">
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="isi" rows="4"> <?php if (isset($agendaedit)) {echo $agendaedit[0]->isi;}  ?></textarea>
                    </div>
                    <input type="hidden" class="form-control" id="countpendamping" name="countpendamping" placeholder="" value="<?php if(isset($pendampingedit)) { echo count($pendampingedit);} else { echo '1';} ?>">
                    <input type="hidden" class="form-control" id="countsatpas" name="countsatpas" placeholder="" value="<?php if(isset($satpassusedit)) { echo count($satpassusedit);} else { echo '1';} ?>">
                </div>
            </div>
        ...
        <div class="col-lg-10">
            ...
            <div class="row form-group">
                ...
                <div class="col-lg-4">
                    ...
                    <input type="hidden" class="form-control" name="surat" value="<?php if (isset($id)) { echo $id;}?>">
