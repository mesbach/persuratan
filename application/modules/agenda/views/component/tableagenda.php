        ...
        <div class="adv-table">
            <table  class="display table table-bordered table-striped" id="dynamic-table">
                ...
                <tbody>
                    <tr >
                        <td >1</td>
                        <td ><a href="<?php echo site_url(); ?>agenda/<?php echo $this->session->userdata['logged_in']['privilege'] ?>/detailAgenda">Acara A</a></td>
                    ...
                    <tr>
                        <td >2</td>
                        <td ><a href="<?php echo site_url(); ?>agenda/<?php echo $this->session->userdata['logged_in']['privilege'] ?>/detailAgenda">Acara B</a></td>
                    ...
                    <tr>
                        <td >3</td>
                        <td ><a href="<?php echo site_url(); ?>agenda/<?php echo $this->session->userdata['logged_in']['privilege'] ?>/detailAgenda">Acara C</a></td>
                    ...
                    <tr>
                        <td >4</td>
                        <td ><a href="<?php echo site_url(); ?>agenda/<?php echo $this->session->userdata['logged_in']['privilege'] ?>/detailAgenda">Acara D</a></td>
                    ...
                    <tr>
                        <td >5</td>
                        <td ><a href="<?php echo site_url(); ?>agenda/<?php echo $this->session->userdata['logged_in']['privilege'] ?>/detailAgenda">Acara E</a></td>
