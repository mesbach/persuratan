    ...
    <div class="col-md-12">
        <section class="panel">
            <header class="panel-heading">
                <strong>Pencarian Agenda Lanjut</strong>
            </header>
            <div class="panel-body">
                <form target="_blank" role="form" action="<?php echo base_url(); ?>search/coord/resultagenda" method="POST">
                ...
                <div class="col-md-8">
                    <div class="row form-group">
                        <div class="col-md-12">
                            ...
                            <span><i>Dapat diisi : Nama Agenda, Tempat, Hasil, atau Keterangan</i></span>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <span class="help-block"><i>Tanggal Agenda</i></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
